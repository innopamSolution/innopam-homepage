    ...
    cases: [
      ...
      },
      {
        ...
        features: [
          ...
          { title: '영상 데이터 업로드 및 전처리', desc: '수집된 영상의 업로드·정합·보정 등 전처리 과정을 자동화하며, AI 분석을 통해 데이터 품질을 향상' },
          { title: '분석결과 시각화', desc: 'GIS 기반 지도 위에 AI 분석 결과를 직관적으로 시각화하여 지역별 변화 현황을 공간 정보와 함께 조회' },
